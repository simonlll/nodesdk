const { createTSFN, InitClient,Connect,sendByteMsg,sendQueryBytesMsg} = require('bindings')('addon');
...
// 构造消息
    ...
    var content = {
        msgTimestamp: "1679892372112",
        fromUserId: "linbin2",
        objectName: "TxtMsg",
        channelType: "PERSON",
        msgUID: "C745-HLLE-02A0-44JF",
        source: "Android",
        toUserId: "zoujia1",
        content: bytecontent
    }
